...
function myfontPanel({
    ...
    return (
        ...
        {editPartForm.modal}
        <Stack gap="xs">
        <Title c={context.theme.primaryColor}  order={3}>my font</Title>
        <Text>
            This is a custom panel for the myfont plugin.
        </Text>
        <SimpleGrid cols={2}>
...
export function rendermyfontPanel(context: InvenTreePluginContext) {
    checkPluginVersion(context);

    return (
        <myfontPanel context={context} />
    );
}
