...
function myfontDashboardItem({
    ...
    const pluginName : string = "myfont";
...
//  component
export function rendermyfontDashboardItem(context: InvenTreePluginContext) {
    checkPluginVersion(context);
    return <myfontDashboardItem context={context} />;
}
