# my font- Frontend Code

This directory contains the frontend code for the my font plugin.
...
This will compile the frontend into the `../my_font/static` directory (ready for distribution).
